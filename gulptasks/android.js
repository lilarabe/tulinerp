 ...
 * 设置android的热更新版本号
 */
gulp.task('set-release-android', ['get-release-android'], () => {
...
gulp.task('copy-hot-code-android-debug', ['set-release-android', 'clean-android-dir-debug'], () => {
 ...
 */
gulp.task('copy-hot-code-android-prod', ['set-release-android', 'clean-android-dir-prod'], () => {
 ...
 * 设置 热更新文件
 */
gulp.task('set-hot-code-android-chcp-prod', ['set-config-xml-android-prod', 'set-cordova-hcp-android-prod'], () => {
  console.log('android 热更新文件配置完毕');
});

gulp.task('set-hot-code-android-chcp-debug', ['set-config-xml-android-debug', 'set-cordova-hcp-android-debug'], () => {
  console.log('android 热更新文件配置完毕');
});
