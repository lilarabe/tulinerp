...
@Component({
  selector: 'list-item-multiimage',
  templateUrl: 'list-item-multiimage.html',
  host: {
    'class': 'list-item-multiimage',
  },
})
export class ListItemMultiimageComponent  extends ListItemClass {
